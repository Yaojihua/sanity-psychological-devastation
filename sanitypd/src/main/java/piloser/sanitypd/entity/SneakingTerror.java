...
public class SneakingTerror extends InnerEntity implements GeoEntity
{
    ...
    /**
     * Sneaking Terror's own psychic resistance: <b>15</b> points, i.e. 15% reduction.
     *
     * <p>Example: 60 points of psychic damage is converted to 60 * (1 - 0.15) * 2.5 = <b>127.5</b>
     * points of real damage.
     */
    @Override
