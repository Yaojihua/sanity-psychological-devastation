...
public class ConfigDefault
{
    ...
    public ConfigDefault(ForgeConfigSpec.Builder builder)
    {
        builder.comment(
                ...
                "NOTE: sanity is point-based here: 100 points (ISanity.MAX_SANITY) = fully sane, 0 points = fully insane;",
                "      positive values grant sanity (good for the player), negative values drain it. Passive values are per second, active values are one-shot.",
